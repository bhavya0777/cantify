...
class _MenuPageState extends State<MyMenuPage> {
  ...
  Widget build(BuildContext context) {
    ...
    //Icon(Icons.tick, color: Colors.orangeAccent,),
    //onPressed: () {
        ...
        return Card(
            ...
            child: ListTile(
              ...
              title: Text('$dname - $rate Rs.',style: GoogleFonts.aladin(textStyle: TextStyle(fontFamily: 'Montserrat',
                ...
                //subtitle: Text(this.menuList[position].rate,style: GoogleFonts.aladin(textStyle: TextStyle(fontFamily: 'Montserrat',
                //fontSize: 20.0,
  ...
  /*void _fetch(BuildContext context, Menu menu) async {
